...
public class Talking_Test_Scr : MonoBehaviour
{
    ...
    void SpawnSecondObject()
    {
        ...
        if (bubbleFrame != null && speakingObject != null)
        {
            ...
            GameObject secondSpawnedObject = Instantiate(speakingObject, secondSpawnPosition, Quaternion.identity); // Spawn the second object
